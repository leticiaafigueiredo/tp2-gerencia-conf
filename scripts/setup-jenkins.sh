...
echo "  2. Expor Jenkins com ngrok: bash scripts/setup-ngrok.sh --webhook"
echo "     (requer conta gratuita em https://ngrok.com e: ngrok config add-authtoken SEU_TOKEN)"
