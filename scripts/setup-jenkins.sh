...
echo "  2. Configurar webhook: bash scripts/configure-github-webhook.sh"
echo "     (Jenkins local requer túnel público, ex.: ngrok, para o GitHub alcançar ${JENKINS_URL}/github-webhook/)"
